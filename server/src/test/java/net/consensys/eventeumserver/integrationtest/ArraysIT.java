...
public class ArraysIT extends BaseKafkaIntegrationTest {
        ...
        public void testEventWithArrays() throws Exception {
                ...
                final ContractEventFilter registeredFilter = registerDummyEventArrayFilter(
                                emitter.getContractAddress());
                ...
                final ArrayList<NumberParameter> uintArray = (ArrayList<NumberParameter>) eventDetails
                                .getNonIndexedParameters().get(0).getValue();

                assertEquals(BigInteger.ONE, uintArray.get(0).getValue());
                assertEquals(BigInteger.TEN, uintArray.get(1).getValue());

                final ArrayList<StringParameter> bytesArray = (ArrayList<StringParameter>) eventDetails
                                .getNonIndexedParameters().get(1).getValue();
