...
public class ChainBootstrapperTest {
        ...
        private List<BlockListener> mockBlockListeners = Arrays.asList(mock(BlockListener.class),
                        mock(BlockListener.class));
        ...
        public void testThatEventFiltersAreRegistered() throws Exception {
                ...
                final List<ContractEventFilter> mockConfiguredFilters = Arrays.asList(mock(ContractEventFilter.class),
                                mock(ContractEventFilter.class));
                final List<ContractEventFilter> mockFilterFactoryFilters = Arrays
                                .asList(mock(ContractEventFilter.class), mock(ContractEventFilter.class));
                ...
                verify(mockSubscriptionService, times(1))
                                .registerContractEventFilterWithRetries(mockConfiguredFilters.get(0), true);
                verify(mockSubscriptionService, times(1))
                                .registerContractEventFilterWithRetries(mockConfiguredFilters.get(1), true);
                verify(mockSubscriptionService, times(1))
                                .registerContractEventFilterWithRetries(mockFilterFactoryFilters.get(0), true);
                verify(mockSubscriptionService, times(1))
        ...
        public void testThatTransactionsMonitorsAreRegistered() throws Exception {
                ...
                final List<TransactionMonitoringSpec> mockMonitorSpecs = Arrays
                                .asList(mock(TransactionMonitoringSpec.class), mock(TransactionMonitoringSpec.class));
                ...
                verify(mockTransactionMonitoringService, times(1))
                                .registerTransactionsToMonitor(mockMonitorSpecs.get(0), true);
                verify(mockTransactionMonitoringService, times(1))
        ...
        public void testThatContractTransactionFiltersAreRegistered() throws Exception {
                ...
                final List<TransactionMonitoringSpec> mockConfiguredFilters = Arrays
                                .asList(mock(TransactionMonitoringSpec.class), mock(TransactionMonitoringSpec.class));
                ...
                verify(mockTransactionMonitoringService, times(1))
                                .registerTransactionsToMonitor(mockConfiguredFilters.get(0), true);
                verify(mockTransactionMonitoringService, times(1))
