 ...
 */
public class BaseEventeumEventConsumer implements EventeumInternalEventConsumer {
    ...
    public BaseEventeumEventConsumer(SubscriptionService subscriptionService,
