...
/**
 * EventEncoder that enabled correct ordering.  Methods extracted from Web3J EventEncoder and Utils.
 */
public class EventEncoder {

    private EventEncoder() { }

    public static String encode(String eventName, List<TypeReference<Type>> parameters) {

        String methodSignature = buildMethodSignature(eventName, parameters);
